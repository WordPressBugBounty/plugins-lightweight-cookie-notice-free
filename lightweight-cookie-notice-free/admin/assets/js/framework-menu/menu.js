	...
	function ($) {
		...
		$( document.body ).on(
			...
			function () {
				...
				$( '.daextlwcnf-main-form__daext-form-section-body[data-section-id="' + target + '"]' ).toggleClass( 'daextlwcnf-main-form__daext-form-section-body-opened' );
		...
		$( document.body ).on(
			'mouseenter',
			'.daextlwcnf-admin-toolbar__menu-item-more',
			function () {
				$( '.daextlwcnf-admin-toolbar__pop-sub-menu' ).show();
			}
		);

		$( document.body ).on(
			'mouseleave',
			'.daextlwcnf-admin-toolbar__menu-item-more, .daextlwcnf-admin-toolbar__pop-sub-menu',
			function () {
				$( '.daextlwcnf-admin-toolbar__pop-sub-menu' ).hide();
			}
		);
		...
		$( document ).on(
			'change',
			'.daextlwcnf-bulk-action-checkbox',
			function () {
				let selectedItems = [];
				$( '.daextlwcnf-bulk-action-checkbox:checked' ).each(
					function () {
